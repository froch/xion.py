...
class QueryBuildAddressRequest(_message.Message):
    ...
    salt: str
    init_args: bytes
    def __init__(self, code_hash: _Optional[str] = ..., creator_address: _Optional[str] = ..., salt: _Optional[str] = ..., init_args: _Optional[bytes] = ...) -> None: ...

class QueryBuildAddressResponse(_message.Message):
    __slots__ = ("address",)
    ADDRESS_FIELD_NUMBER: _ClassVar[int]
    address: str
    def __init__(self, address: _Optional[str] = ...) -> None: ...

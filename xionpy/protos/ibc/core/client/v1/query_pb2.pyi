...
class QueryVerifyMembershipRequest(_message.Message):
    __slots__ = ("client_id", "proof", "proof_height", "merkle_path", "value", "time_delay", "block_delay")
    CLIENT_ID_FIELD_NUMBER: _ClassVar[int]
    PROOF_FIELD_NUMBER: _ClassVar[int]
    PROOF_HEIGHT_FIELD_NUMBER: _ClassVar[int]
    ...
    proof: bytes
    proof_height: _client_pb2.Height
    merkle_path: _commitment_pb2.MerklePath
    value: bytes
    time_delay: int
    block_delay: int
    def __init__(self, client_id: _Optional[str] = ..., proof: _Optional[bytes] = ..., proof_height: _Optional[_Union[_client_pb2.Height, _Mapping]] = ..., merkle_path: _Optional[_Union[_commitment_pb2.MerklePath, _Mapping]] = ..., value: _Optional[bytes] = ..., time_delay: _Optional[int] = ..., block_delay: _Optional[int] = ...) -> None: ...

class QueryVerifyMembershipResponse(_message.Message):
    __slots__ = ("success",)

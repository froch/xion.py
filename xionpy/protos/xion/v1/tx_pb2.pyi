...
class MsgSetPlatformPercentage(_message.Message):
    __slots__ = ("authority", "platform_percentage")
    AUTHORITY_FIELD_NUMBER: _ClassVar[int]
    PLATFORM_PERCENTAGE_FIELD_NUMBER: _ClassVar[int]
    authority: str
    platform_percentage: int
    def __init__(self, authority: _Optional[str] = ..., platform_percentage: _Optional[int] = ...) -> None: ...

class MsgSetPlatformPercentageResponse(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...
